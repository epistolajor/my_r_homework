...
**Summary**
    ...
    "The results of this project highlight the importance of Quarterback play and success for all players on the Football field. Specifically, several measures relating to the prior year Quarterback play (e.g. QB Attempts, QB Rating, QB Percentage) significantly predicted upcoming Fantasy Success for Runningbacks, Wide Recievers & Tight Ends to a much greater degree then traditional predictors (Prior year Fantasy success, Fantasy rankings, # of attempts, # of targets, #yards, #downs played, etc. Evidently, these results support the notion that the Quarterback is the most important position in Football."
...
head(FF.2014) #to Visualize all Predictors
```
...
#Top 3 Individual Predictor Interpretations Only - APA
    
"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Rating (BF10 = 2161583) in explaining 2015 Running Back Fantasy Points per Game (PPR)"

"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Completion Percentage (BF10 = 144626.6) in explaining 2015 Running Back Fantasy Points per Game (PPR)"

"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Touchdowns (BF10 = 3550.632) in explaining 2015 Running Back Fantasy Points per Game (PPR)"
...
#Final Model
    ...
    #Top Model Interperation Only
    "Bayesian Analysis revealed that the data offers greatest support for a 2 predictor model of 2014 Quarterback Completion Percentage & 2014 Number of Wins (BF10 = 10632973) in explaining Runningback 2015 Fantasy Points per Game (PPR)."      
...
"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Rating (BF10 = 8.490072e+16) in explaining 2015 Wide Reciever Fantasy Points per Game (PPR)"

"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Touchdowns (BF10 = 927447042) in explaining 2015 Wide Reciever Fantasy Points per Game (PPR)"

"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Completion Percentage (BF10 = 76021322) in explaining 2015 Wide Reciever Fantasy Points per Game (PPR)"
...
#Final Model
    ...
    BayesModel.WR.Final <- generalTestBF(PPG.PPR.2015 ~ QB.Rate + QB.Per + QB.Yds + Win + DP + DP.Per + Rec.Tgt + Rec.1st + Pts.PPR.14, data = as.data.frame(WR.Data))
         ...
         sort(BayesModel.WR.Final, TRUE)[3] #QB.Rate + DP : 4.870829e+16 ±0%
             ...
             #Top Model Interperation Only
         "Bayesian Analysis revealed that the data offers greatest support for a 1 predictor model of 2014 Quarterback Rating (BF10 = 8.490072e+16) in explaining Wide Reciever 2015 Fantasy Points per Game (PPR)."
...
"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Rating (BF10 = 699243481) in explaining 2015 Tight End Fantasy Points per Game (PPR)"

"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Touchdowns (BF10 = 4904.773) in explaining 2015 Tight End Fantasy Points per Game (PPR)"

"Bayseian Analysis revealed that the data offers support for the predictor of 2014 Quarterback Completion Percentage (BF10 = 1371.197) in explaining 2015 Tight End Fantasy Points per Game (PPR)"
...
#Final Model
    ...
    #Top Model Interperation Only
         "Bayesian Analysis revealed that the data offers greatest support for a 1 predictor model of 2014 Quarterback Rating (BF10 = 699243481) in explaining Tight End 2015 Fantasy Points per Game (PPR)."
...
#APA Interpretations Mentioned in RB Section Above
```
...
#APA Interpretations Mentioned in WR Section Above
```
...
#APA Interpretations Mentioned in TE Section Above
```
