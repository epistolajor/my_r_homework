...
is.numeric(FantasyFootball2014$PPG.2015)
head(FantasyFootball2014.Copy)

#Regression Bayes Function
#regression.bayes <- function(predictor){
 # is.numeric(FantasyFootball2014$PPG.2015)
 # bayes.results <- generalTestBF(PPG.2015 ~ get(predictor), data = FantasyFootball2014.Copy)
...
#regression.bayes(c("Att" , "Per" , "Yds" , "TD" , "Int" , "Rate"))


# generalTestBF(PPG.2015 ~ Att + Per, data = FantasyFootball2014.Copy)
#generalTestBF(PPG.2014 ~ PPG.2015 + Downs.Played + Total.First.Down + Total.Yards + Total.Touchdowns, data = Position.Analysis)

"WTF. I keep getting this error that the DV is not"
