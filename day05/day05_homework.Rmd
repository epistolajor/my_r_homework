...
#Position.Analysis$Median.Yrds <- summarize(group_by(Position.Analysis, Player, Position), median = median(Total.First.Downs))
#Position.Analysis$Median.Tds <- summarize(group_by(Position.Analysis, Player, Position), median = median(Total.First.Downs))

"Replacement has 140 rows, data has 141??? How do I fix this?"
